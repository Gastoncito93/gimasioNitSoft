  ...
  <div class="auth-card">
    ...
    <form method="post">
      <div class="auth-form-group">
        ...
        <input class="inp" type="password" name="password_actual" required placeholder="Tu clave actual">
      </div>
      <div class="auth-form-group">
        <label class="auth-label">Nueva Contraseña</label>
        <input class="inp" type="password" name="password_nueva" required placeholder="Mínimo 6 caracteres">
      </div>
      <div class="auth-form-group">
        <label class="auth-label">Repetir Nueva Contraseña</label>
        <input class="inp" type="password" name="password_nueva2" required placeholder="Confirmar nueva clave">
      </div>
